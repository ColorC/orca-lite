...
export async function readFederatedWorkerOutput(args: {
  ...
  args.db.updateFederatedDispatchRuntimeEpoch(args.dispatchId, capability.runtimeEpoch)
  if (!capability.supported) {
    const legacy = await readLegacy(args)
    args.db.updateFederatedDispatchRuntimeEpoch(args.dispatchId, legacy.remoteRuntimeEpoch)
  ...
  try {
    ...
    args.db.updateFederatedDispatchRuntimeEpoch(args.dispatchId, remote.runtimeEpoch)
    return {
      ...remote.output,
